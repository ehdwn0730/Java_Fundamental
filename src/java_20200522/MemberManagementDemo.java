...
public class MemberManagementDemo {
	...
	public String input(String msg) {
		...
		return sc.next(); // 키보드에서 입력한 데이터를 변환해준다.
	}
	...
	public void insert() {
		...
		Member m = new Member(id, name); //1, 2번
		list.add(m); //3번
	...
	//1. 수정한 아이디를 입력받는다.
	//2. ArrayList에 있는 고객정보에서 수정할 아이디를 찾아서 있으면 
	//	  수정할 이름을 입력받고, ArrayList에 고객정보를 수정한다.
	...
	//1. 검색할 아이디를 입력 받는다.
	//2. ArrayList에 Member 객체 중에서 검색할 아이디를 찾아서 있으면 출력하고
	//   없으면 "검색된 결과가 없습니다." 메세지를 출력
	//3. ArrayList에 있는 모든 고객을 출력한다.
	//4. print() 메서드 호출
	//5. 번호를 선택하세요> 메세지를 출력한 후 키보드 입력을 받게 한다.
	public void search() {
